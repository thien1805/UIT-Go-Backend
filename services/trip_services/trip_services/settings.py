"""
Django settings for trip_services project.
...
MIDDLEWARE = [
    ...
    'trip_services.middleware.JWTAuthMiddleware',  # JWT authentication middleware
]

ROOT_URLCONF = 'trip_services.urls'
...
WSGI_APPLICATION = 'trip_services.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='trip_service'),     # Tên database
